...
// ══════════════════════════════════════════════════════════════
export const PROJECTOR_STAGGER = 0.15;      // dramatic pause between projectors in same group
export const PROJECTOR_FADE_DURATION = 0.6; // seconds for each projector to fade in
export const PROJECTOR_READING_DELAY = 0.3; // seconds to let users read cards before next group
